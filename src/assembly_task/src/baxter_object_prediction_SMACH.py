...
class webcam_image:
    ...
    def __init__(self):
        ...
        self.exec_assembly_sub = rospy.Subscriber("exec_assembly", Bool, self.execCallback)
    ...
    def execCallback(self,data):
        self.exec_state = data.data
        print (self.exec_state)

    def callback(self,data):
        if not self.is_moving and self.exec_state == True: # ADD SMACH LOGIC
...
def main(args):
    rospy.init_node('webcam_image_SMACH', anonymous=True)
    ic = webcam_image()
