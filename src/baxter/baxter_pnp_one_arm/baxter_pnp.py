...
def picknplace():
    ...
    pos1 = [-1.4262186375364634, 0.8314175870338942, 0.14457768925820025, -0.14841264122791378, -1.7422186798408588, -1.5615924420673513, 0.08590292412158317, 0.5867476513661708, 1.7107720736892076, 0.8241311782914386, -0.763922432366936, -0.6396699885482175, 0.8103253512004698, -2.4014469234346154]
    ...
    placegoal.pose.position.x = 0.50
    placegoal.pose.position.y = 0.20
	...
	if start:
	    ...
	    #for e in range(0, k):
            ...
            if k>0:
	        p.attachBox(boxlist[0], 0.025, 0.025, 0.025*k, placegoal.pose.position.x, placegoal.pose.position.y, center_z_cube, 'base', touch_links=['cubes']) 
	    p.waitForSync()
